    ...
    <>
      ...
      <section className="py-16 px-[6vw] max-w-3xl mx-auto">
        <div className="space-y-5 text-muted text-[15px] leading-relaxed">
          <p>
            Eu sou o <strong className="text-text font-medium">Rafael</strong>, estudante de
          ...
          <p>
            Tenho interesse genuíno em{" "}
            <strong className="text-text font-medium">IA generativa</strong> —
          ...
          <p>
            Atualmente estou também estudando{" "}
            <strong className="text-text font-medium">Python</strong> de forma ativa, com foco
            em FastAPI e automações com IA, expandindo meu repertório para além do ecossistema
            JavaScript. Tenho facilidade para aprender novas tecnologias de forma autônoma e
            gosto de testar na prática.
          </p>
          <p>
      ...
      <section className="py-16 px-[6vw] max-w-6xl mx-auto">
        ...
        <div className="flex flex-wrap gap-4">
          <div className="flex items-center gap-3 rounded-lg border border-border px-5 py-3.5 hover:border-cool transition-colors duration-200">
            ...
            <div>
              <p className="text-[13px] font-medium text-text">Português</p>
              <p className="font-mono text-[10.5px] text-muted-dim tracking-wide">Nativo</p>
            </div>
          </div>
          <div className="flex items-center gap-3 rounded-lg border border-border px-5 py-3.5 hover:border-cool transition-colors duration-200">
            <span className="text-xl">🇺🇸</span>
            <div>
              <p className="text-[13px] font-medium text-text">Inglês</p>
              <p className="font-mono text-[10.5px] text-muted-dim tracking-wide">Intermediário</p>
            </div>
          </div>
        </div>
      </section>
