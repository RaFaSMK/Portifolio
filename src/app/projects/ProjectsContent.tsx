...
import { PathfinderBackground } from "@/components/PathfinderBackground/PathfinderBackground";
...
export function ProjectsContent({ projects }: { projects: Project[] }) {
  return (
    <>
      {/* Hero */}
      <section className="relative min-h-[50vh] flex items-end overflow-hidden pb-16">
        ...
        <div className="relative z-10 w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-24">
          ...
          >
            <a
              ...
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg text-sm font-medium bg-accent/80 text-foreground border border-border hover:bg-accent transition-all duration-300"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg text-sm font-medium bg-[#0077B5]/10 text-[#0077B5] border border-[#0077B5]/25 hover:bg-[#0077B5]/20 transition-all duration-300"
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
